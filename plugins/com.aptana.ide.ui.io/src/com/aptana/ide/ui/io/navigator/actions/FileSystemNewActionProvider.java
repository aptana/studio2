...
public class FileSystemNewActionProvider extends CommonActionProvider {
    ...
    public void init(ICommonActionExtensionSite aSite) {
        ...
        if (aSite.getViewSite() instanceof ICommonViewerWorkbenchSite) {
            ...
            fToolbarNewAction = new FileSystemToolbarNewAction(viewSite.getWorkbenchWindow());
            fContribute = true;
        }
    }
    ...
    public void fillActionBars(IActionBars actionBars) {
        if (fContribute) {
            ...
            if (!toolbarAdded) {
                ...
                if (items.length > 0) {
                    manager.insertBefore(items[0].getId(), fToolbarNewAction);
                    manager.insertBefore(items[0].getId(), new Separator());
                } else {
                    manager.add(fToolbarNewAction);
    ...
    private void updateSelection() {
        ...
        fToolbarNewAction.selectionChanged(getSelection());
    }
}
