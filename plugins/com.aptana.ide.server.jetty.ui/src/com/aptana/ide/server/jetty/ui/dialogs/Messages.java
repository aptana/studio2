...
{
	private static final String BUNDLE_NAME = "com.aptana.ide.server.jetty.ui.dialogs.messages"; //$NON-NLS-1$
	/**
	 * JettyConfigurationDialog_APP_ID
	 */
	public static String JettyConfigurationDialog_APP_ID;
	/**
	 * JettyConfigurationDialog_CHOOSE_BUTTON_TITLE
	 */
	public static String JettyConfigurationDialog_CHOOSE_BUTTON_TITLE;
	/**
	 * JettyConfigurationDialog_CONTAINER_DIALOG_MESSAGE
	 */
	public static String JettyConfigurationDialog_CONTAINER_DIALOG_MESSAGE;
	/**
	 * JettyConfigurationDialog_CONTEXT_ROOT_VALIDATION_MESSAGE
	 */
	public static String JettyConfigurationDialog_CONTEXT_ROOT_VALIDATION_MESSAGE;
	/**
	 * JettyConfigurationDialog_Description
	 */
