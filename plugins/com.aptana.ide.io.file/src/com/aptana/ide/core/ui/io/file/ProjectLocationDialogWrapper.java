...
/**
 * This class is for bridging the old implementation of ProjectLocationDialog
 * and the new one so we do not need to update the codes in all its clients.
 * 
 * @author Michael Xia (mxia@aptana.com)
 */
public class ProjectLocationDialogWrapper implements IVirtualFileManagerDialog {

    private ProjectLocationDialog dialog;

    public ProjectLocationDialogWrapper(ProjectLocationDialog dialog) {
        this.dialog = dialog;
    }
