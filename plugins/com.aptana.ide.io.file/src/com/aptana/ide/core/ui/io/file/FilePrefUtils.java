...
public class FilePrefUtils
{
	...
	{
		return FilePlugin.getDefault().getPreferenceStore().getInt(IPreferenceConstants.DIRECTORY_PERMISSION);
	}
	...
	{
		return FilePlugin.getDefault().getPreferenceStore().getInt(IPreferenceConstants.FILE_PERMISSION);
	}
