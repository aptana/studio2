...
/**
 * (non-Javadoc) A <code>DrillStack</code> manages a stack of DrillFrames. This class is not intended for use beyond
 * the package.
 */
/* package */class DrillStack
{
	...
	/**
	 * Returns true if backward navigation is possible. This is only true if the stack size is greater than 0.
	 * 
	...
	/**
	 * Returns true if "go home" is possible. This is only true if the stack size is greater than 0.
	 * 
