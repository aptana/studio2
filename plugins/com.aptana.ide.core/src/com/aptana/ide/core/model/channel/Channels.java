 ...
 */
public class Channels extends CoreGroupObject<Channel>
{

	/**
	 * CHANNELS_ELEMENT
	 */
	public static final String CHANNELS_ELEMENT = "channels"; //$NON-NLS-1$
	...
	{
		return Messages.getString("Channels.LoggingPrefix"); //$NON-NLS-1$
	}
	 ...
	 */
	public boolean shouldAdd(Channel item)
	{
		return item.getId() != null && item.getChannelType() != null;
	}
	 ...
	 */
	protected Channel[] createEmptyArray()
	{
