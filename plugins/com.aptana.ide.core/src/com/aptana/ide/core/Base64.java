...
public final class Base64
{
	...
	public static String encodeObject(java.io.Serializable serializableObject, int options)
	{
		...
		{
			IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_UnableToWriteOutputStream, e); 
			return null;
		} // end catch
		finally
		{
	...
	private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset)
	{
		...
		else
		{
			...
			{
				IdeLog.logError(AptanaCorePlugin.getDefault(), "" + source[srcOffset] + ": " //$NON-NLS-1$ //$NON-NLS-2$
						+ (DECODABET[source[srcOffset]]));
				IdeLog.logError(AptanaCorePlugin.getDefault(), "" + source[srcOffset + 1] + ": " //$NON-NLS-1$ //$NON-NLS-2$
						+ (DECODABET[source[srcOffset + 1]]));
				IdeLog.logError(AptanaCorePlugin.getDefault(), "" + source[srcOffset + 2] + ": " //$NON-NLS-1$ //$NON-NLS-2$
						+ (DECODABET[source[srcOffset + 2]]));
				IdeLog.logError(AptanaCorePlugin.getDefault(), "" + source[srcOffset + 3] + ": " //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static byte[] decode(byte[] source, int off, int len)
	{
		...
		for (i = off; i < off + len; i++)
		{
			...
			{
				IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_BadBase64InputCharacterAt + i + ": " + source[i]  //$NON-NLS-1$
						+ Messages.Base64_Decimal); 
				return null;
			} // end else:
	...
	public static Object decodeToObject(String encodedObject)
	{
		...
		{
			IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_UnableToReadFromStream, e); 
			obj = null;
		} // end catch
		catch (java.lang.ClassNotFoundException e)
		{
			IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_CanNotFindClass, e); 
			obj = null;
		} // end catch
		finally
		{
	...
	public static byte[] decodeFromFile(String filename)
	{
		...
		try
		{
			...
			{
				IdeLog.logError(AptanaCorePlugin.getDefault(), StringUtils.format(Messages.Base64_FileIsTooBigForThisConvenienceMethod, file.length())); 
				return null;
		...
		{
			IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_ErrorDecodingFromFile + filename); 
		} // end catch: IOException
		finally
		{
			try
	...
	public static String encodeFromFile(String filename)
	{
		...
		{
			IdeLog.logError(AptanaCorePlugin.getDefault(), Messages.Base64_ErrorEncodingFromFile + filename); 
		} // end catch: IOException
		finally
		{
			try
	...
	public static class InputStream extends java.io.FilterInputStream
	{
		...
		public int read() throws java.io.IOException
		{
			...
			if (position < 0)
			{
				...
				else
				{
					...
					else
					{
						...
						throw new java.io.IOException(Messages.Base64_ImproperlyPaddedBase64Input); 
					} // end
			...
			else
			{
				...
				throw new java.io.IOException(Messages.Base64_ErrorInBase64CodeReadingStream); 
			} // end else
		} // end read
	...
	public static class OutputStream extends java.io.FilterOutputStream
	{
		...
		public void write(int theByte) throws java.io.IOException
		{
			...
			else
			{
				...
				{
					throw new java.io.IOException(Messages.Base64_InvalidCharacterInBase64Data); 
		...
		public void flushBase64() throws java.io.IOException
		{
			if (position > 0)
			{
				...
				{
					throw new java.io.IOException(Messages.Base64_Base64InputNotProperlyPadded); 
				} // end else: decoding
