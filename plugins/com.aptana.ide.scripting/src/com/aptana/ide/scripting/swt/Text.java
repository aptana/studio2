 ...
 * @author paul
 */
public class Text extends ScriptableObject
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3265256739723949543L;
	/*
	 * Fields
	 */
	private org.eclipse.swt.widgets.Text _text;
	...
	public static Scriptable jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr)
	{
		...
		{
			text._text = new org.eclipse.swt.widgets.Text((Composite) parent, style);
		}
		else
		{
			IdeLog.logError(ScriptingPlugin.getDefault(), Messages.Text_Parent_Not_Composite);
		}
		return text;
	}
	...
	{
		_text.setLayoutData(new GridData(style));
	}
