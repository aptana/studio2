 ...
 * @author Paul Colton
 */
public class ProfilesMoveDownEvent extends Event
{
	 ...
	 */
	public static final String eventType = "ProfilesMoveDownEvent"; //$NON-NLS-1$
	 ...
	 * @param uris
	 */
	public ProfilesMoveDownEvent(Object target, int id, ProfileURI[] uris)
	{
