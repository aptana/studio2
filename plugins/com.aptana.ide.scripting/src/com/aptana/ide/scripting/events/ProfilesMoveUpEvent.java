 ...
 * @author Paul Colton
 */
public class ProfilesMoveUpEvent extends Event
{
	 ...
	 */
	public static final String eventType = "ProfilesMoveUpEvent"; //$NON-NLS-1$
	 ...
	 * @param uris
	 */
	public ProfilesMoveUpEvent(Object target, int id, ProfileURI[] uris)
	{
