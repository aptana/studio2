...
public class PreferenceInitializer extends AbstractPreferenceInitializer
{
	...
	public void initializeDefaultPreferences()
	{
		...
		store.setDefault(IPreferenceConstants.PREF_AUTO_BACKUP_PATH, ResourcesPlugin.getWorkspace().getRoot()
				.getLocation().toOSString()
				+ File.separatorChar + "preferences"); //$NON-NLS-1$
		store
				.setDefault(
						IPreferenceConstants.PREF_FILE_EXPLORER_WEB_FILES,
