 ...
 *
 */
/* package */ class WebBrowserEditorInput extends org.eclipse.ui.internal.browser.WebBrowserEditorInput {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ui.internal.browser.WebBrowserEditorInput#isNameLocked()
	 */
	@Override
	protected boolean isNameLocked() {
		return super.isNameLocked();
	}
