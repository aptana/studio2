...
/**
 * Uncloaks a specific file type so the files will be ignored during syncing.
 * 
 * @author Michael Xia (mxia@aptana.com)
 */
public class ResourceUncloakAction implements IObjectActionDelegate {

    private List<IResource> fSelectedResources;

    public ResourceUncloakAction() {
