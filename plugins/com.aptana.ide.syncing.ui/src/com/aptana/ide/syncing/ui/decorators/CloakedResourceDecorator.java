 ...
 */
public class CloakedResourceDecorator extends CloakedLabelDecorator {
    ...
    public void decorate(Object element, IDecoration decoration) {
        ...
        // only shows the cloak decorator when the project has a sync connection
        if (SiteConnectionManager.getSitesWithSource(resource.getProject()).length == 0) {
            return;
        }
