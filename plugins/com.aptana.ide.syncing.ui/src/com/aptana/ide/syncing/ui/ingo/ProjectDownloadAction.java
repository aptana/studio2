...
{
	/**
	 * @see com.aptana.ide.syncing.ui.ingo.BaseSyncAction#selectionChanged(org.eclipse.jface.action.IAction, org.eclipse.jface.viewers.ISelection)
	 */
	public void selectionChanged(IAction action, ISelection selection)
	{
		super.selectionChanged(action, selection);
		IVirtualFile[] convertedResources = ProjectFileManager.convertResourcesToFiles(selectedObjects);
		selectedFiles = extractIVirtualFilesFromSelection(convertedResources);
