...
public class SyncInfoDialog extends Dialog implements SelectionListener {
    ...
    public void widgetSelected(SelectionEvent e) {
        ...
        if (source == browseLocalPath) {
            ...
            if (o != null && o instanceof ProtocolManager) {
                ...
                IVirtualFileManagerDialog d = pm.createPropertyDialog(SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
    ...
    protected void okPressed() {
        ...
        if (target.getSelectionIndex() >= 0) {
            ...
            _item.setDestinationFileManager(virtualFileManagers.get(selection
                    .getText()));
        }
        super.okPressed();
    }
