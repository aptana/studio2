...
{
	private static final Image FOLDER_ICON = SnippetsPlugin.getImage("icons/folder.gif"); //$NON-NLS-1$
	private static final Image SNIPPET_ICON = SnippetsPlugin.getImage("icons/snippet.png"); //$NON-NLS-1$
