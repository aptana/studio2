	...
	public void linkActivated()
	{
		try
		{
			...
			MessageDialog.openInformation(
				...
				Messages.getString("JSConsoleHyperlink.Information"), StringUtils.format(Messages.getString("JSConsoleHyperlink.SourceNotFoundFor_0"), new String[] { fFilename })); //$NON-NLS-1$ //$NON-NLS-2$
		}
