...
{	
	...
	public HttpServerProcess(ILaunch launch) throws DebugException
	{
		...
		this.launchListener = new ILaunchListener()
		{
			...
			public void launchAdded(ILaunch launch)
			{
				...
				/* Shutdown server on next launch if all other launch processes are terminated */
		...
		this.label = StringUtils.format(Messages.HttpServerProcess_LocalHTTPServer_0, baseUrl.toExternalForm());
	...
	{
		throw new DebugException(new Status(IStatus.ERROR, com.aptana.ide.debug.core.JSDebugPlugin.ID, DebugException.REQUEST_FAILED, StringUtils.EMPTY, exception));
	}
