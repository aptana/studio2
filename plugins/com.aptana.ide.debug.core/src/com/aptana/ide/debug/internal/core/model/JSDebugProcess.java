...
public class JSDebugProcess extends PlatformObject implements IProcess, IDebugEventSetListener
{
	...
	private void terminateProcess() throws DebugException {
		if (process != null && !processTerminated && killProcessOnTerminate) {
			...
			throw new DebugException(
					new Status(IStatus.ERROR, JSDebugPlugin.ID, DebugException.TARGET_REQUEST_FAILED,
	...
	{
		throw new DebugException(new Status(IStatus.ERROR, JSDebugPlugin.ID,
				DebugException.REQUEST_FAILED, StringUtils.EMPTY, exception));
	}
