...
{
	private Map<String, IXHRTransfer> transfers = new LinkedHashMap<String, IXHRTransfer>(); /* preserve insertion order */
	...
	/**
	 * @see com.aptana.ide.debug.core.xhr.IXHRService#getTransfers()
	 */
	...
	/**
	 * @see com.aptana.ide.debug.core.xhr.IXHRService#getTransfersCount()
	 */
