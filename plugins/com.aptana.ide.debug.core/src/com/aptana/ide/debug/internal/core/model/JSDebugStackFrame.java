...
public class JSDebugStackFrame extends JSDebugElement implements IJSStackFrame
{
	...
	/**
	 * @see com.aptana.ide.debug.core.model.IJSStackFrame#getSourceFileName()
	 */
	...
	private void getVariables0() throws DebugException
	{
		...
		variables = ((JSDebugTarget) getDebugTarget()).loadVariables(StringUtils.format("frame[{0}]", frameId)); //$NON-NLS-1$
	...
	/**
	 * @see com.aptana.ide.debug.core.model.IJSStackFrame#findVariable(java.lang.String)
	 */
