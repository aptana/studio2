...
public abstract class JSDebugElement extends DebugElement
{
	...
	{
		throw new DebugException(new Status(IStatus.ERROR, JSDebugPlugin.ID, code, message, exception));
	}
	...
	{
		throw new DebugException(new Status(IStatus.ERROR, JSDebugPlugin.ID, IStatus.OK, "not implemented", null)); //$NON-NLS-1$
	}
}
