...
public interface IJSLineBreakpoint extends ILineBreakpoint
{
	...
	/**
	 * Returns the conditional expression associated with this breakpoint, or <code>null</code> if this breakpoint
	...
	/**
	 * Returns whether the breakpoint suspends when the value of the condition is <code>true</code> or when the value
	...
	/**
	 * Set the suspend state of this breakpoint's condition. If the value is <code>true</code>, the breakpoint will
	 * stop when the value of the condition is <code>true</code>. If the value is <code>false</code>, the
