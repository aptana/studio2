...
public abstract class FormatterTabPage extends ModifyDialogTabPage {
	...
	private final static String SHOW_INVISIBLE_PREFERENCE_KEY= Activator.PLUGIN_ID + ".formatter_page.show_invisible_characters"; //$NON-NLS-1$
	...
	/**
	 * @see com.aptana.ide.ui.editors.preferences.formatter.ModifyDialogTabPage#doCreatePreviewPane(org.eclipse.swt.widgets.Composite, int)
	 */
