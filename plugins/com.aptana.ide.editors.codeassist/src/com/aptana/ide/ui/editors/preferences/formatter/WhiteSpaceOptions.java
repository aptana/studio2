...
import com.aptana.ide.ui.editors.preferences.formatter.SnippetPreview.PreviewSnippet;
...
public final class WhiteSpaceOptions {
	...
	public static class InnerNode extends Node {
	    ...
	    /**
	     * @see com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.Node#setChecked(boolean)
	     */
        ...
        /**
         * @see com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.Node#getSnippets()
         */
        ...
        /**
         * @see com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.Node#getCheckedLeafs(java.util.List)
         */
	...
	public static class OptionNode extends Node {
         ...
         */
        public void setChecked(boolean checked) {
        	fWorkingValues.put(fKey, checked ? CommentsTabPage.INSERT : CommentsTabPage.DO_NOT_INSERT);
        }
        ...
        public boolean getChecked() {
            return CommentsTabPage.INSERT.equals(fWorkingValues.get(fKey));
        }
...
//    "this(x, y);\n"); //$NON-NLS-1$
	...
	private void createAfterAndTree(Map workingValues, final InnerNode parent) {
        createOption(parent, workingValues, FormatterMessages.WhiteSpaceOptions_type_parameters, DefaultCodeFormatterConstants.FORMATTER_DO_NOT_INDENT_TAGS, TYPE_PARAMETER_PREVIEW); 
 	}
    ...
    private void createBetweenEmptyParenTree(Map workingValues, final InnerNode parent) {
        ...
        createOption(parent, workingValues, FormatterMessages.WhiteSpaceOptions_annotation_type_member, DefaultCodeFormatterConstants.DO_NOT_WRAP_SIMPLE_TAGS, ANNOTATION_DECL_PREVIEW); 
    }
    ...
    private InnerNode createAnnotationTypeTree(Map workingValues, InnerNode parent) {
        ...
        createOption(root, workingValues, FormatterMessages.WhiteSpaceTabPage_annot_type_method_between_empty_parens, DefaultCodeFormatterConstants.DO_NOT_WRAP_SIMPLE_TAGS, ANNOTATION_DECL_PREVIEW); 
        return root;
    }
    ...
    private InnerNode createTypeParameterTree(Map workingValues, InnerNode parent) {
        ...
        createOption(root, workingValues, FormatterMessages.WhiteSpaceTabPage_after_and_list, DefaultCodeFormatterConstants.FORMATTER_DO_NOT_INDENT_TAGS, TYPE_PARAMETER_PREVIEW); 
