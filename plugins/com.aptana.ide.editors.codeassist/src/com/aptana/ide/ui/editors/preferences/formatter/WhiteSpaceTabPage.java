...
import com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.InnerNode;
import com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.Node;
import com.aptana.ide.ui.editors.preferences.formatter.WhiteSpaceOptions.OptionNode;
...
public class WhiteSpaceTabPage extends FormatterTabPage {
	...
	private final class SyntaxComponent implements ISelectionChangedListener, ICheckStateListener, IDoubleClickListener {
	    ...
	    private final String PREF_NODE_KEY= Activator.PLUGIN_ID + "formatter_page.white_space_tab_page.node"; //$NON-NLS-1$
	...
	private final class JavaElementComponent implements ISelectionChangedListener, ICheckStateListener {
	    ...
	    private final String PREF_INNER_INDEX= Activator.PLUGIN_ID + "formatter_page.white_space.java_view.inner"; //$NON-NLS-1$ 
		private final String PREF_OPTION_INDEX=Activator.PLUGIN_ID + "formatter_page.white_space.java_view.option"; //$NON-NLS-1$
	...
	private final class SwitchComponent extends SelectionAdapter {
	    private final String PREF_VIEW_KEY= Activator.PLUGIN_ID + "formatter_page.white_space_tab_page.view"; //$NON-NLS-1$
	 ...
	 * @param editor
	 */
	public WhiteSpaceTabPage(IModificationListener modifyListener,
			Map workingValues, String editor) {
    ...
    protected Preview doCreateJavaPreview(Composite parent) {
        fPreview= new SnippetPreview(fWorkingValues, parent,editor, null);
        return fPreview;
    }
