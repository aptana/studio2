...
public class Entities
{
	...
	private static final String[][] BASIC_ARRAY = { { "quot", "34" }, // " - double-quote //$NON-NLS-1$ //$NON-NLS-2$
			{ "amp", "38" }, // & - ampersand //$NON-NLS-1$ //$NON-NLS-2$
			{ "lt", "60" }, // < - less-than //$NON-NLS-1$ //$NON-NLS-2$
			{ "gt", "62" }, // > - greater-than //$NON-NLS-1$ //$NON-NLS-2$
	};

	private static final String[][] APOS_ARRAY = { { "apos", "39" }, // XML apostrophe //$NON-NLS-1$ //$NON-NLS-2$
	};

	// package scoped for testing
	static final String[][] ISO8859_1_ARRAY = { { "nbsp", "160" }, // non-breaking space //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "laquo", "171" }, // left-pointing double angle quotation mark = left pointing //$NON-NLS-1$ //$NON-NLS-2$
			// guillemet
			...
			{ "raquo", "187" }, // right-pointing double angle quotation mark = right pointing //$NON-NLS-1$ //$NON-NLS-2$
			// guillemet
			...
			{ "Agrave", "192" }, // - uppercase A, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Aacute", "193" }, // - uppercase A, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Acirc", "194" }, // - uppercase A, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Atilde", "195" }, // - uppercase A, tilde //$NON-NLS-1$ //$NON-NLS-2$
			{ "Auml", "196" }, // - uppercase A, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "Egrave", "200" }, // - uppercase E, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Eacute", "201" }, // - uppercase E, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ecirc", "202" }, // - uppercase E, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Euml", "203" }, // - uppercase E, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			{ "Igrave", "204" }, // - uppercase I, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Iacute", "205" }, // - uppercase I, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Icirc", "206" }, // - uppercase I, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Iuml", "207" }, // - uppercase I, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			{ "ETH", "208" }, // - uppercase Eth, Icelandic //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ntilde", "209" }, // - uppercase N, tilde //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ograve", "210" }, // - uppercase O, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Oacute", "211" }, // - uppercase O, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ocirc", "212" }, // - uppercase O, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Otilde", "213" }, // - uppercase O, tilde //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ouml", "214" }, // - uppercase O, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			{ "times", "215" }, // multiplication sign //$NON-NLS-1$ //$NON-NLS-2$
			{ "Oslash", "216" }, // - uppercase O, slash //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ugrave", "217" }, // - uppercase U, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Uacute", "218" }, // - uppercase U, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Ucirc", "219" }, // - uppercase U, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "Uuml", "220" }, // - uppercase U, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			{ "Yacute", "221" }, // - uppercase Y, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "THORN", "222" }, // - uppercase THORN, Icelandic //$NON-NLS-1$ //$NON-NLS-2$
			{ "szlig", "223" }, // - lowercase sharps, German //$NON-NLS-1$ //$NON-NLS-2$
			{ "agrave", "224" }, // - lowercase a, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "aacute", "225" }, // - lowercase a, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "acirc", "226" }, // - lowercase a, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "atilde", "227" }, // - lowercase a, tilde //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "egrave", "232" }, // - lowercase e, grave accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "eacute", "233" }, // - lowercase e, acute accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "ecirc", "234" }, // - lowercase e, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "icirc", "238" }, // - lowercase i, circumflex accent //$NON-NLS-1$ //$NON-NLS-2$
			{ "iuml", "239" }, // - lowercase i, umlaut //$NON-NLS-1$ //$NON-NLS-2$
			{ "eth", "240" }, // - lowercase eth, Icelandic //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "otilde", "245" }, // - lowercase o, tilde //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "thorn", "254" }, // - lowercase thorn, Icelandic //$NON-NLS-1$ //$NON-NLS-2$
	...
	// <!-- Latin Extended-B -->
			...
			{ "crarr", "8629" }, // downwards arrow with corner leftwards= carriage return, //$NON-NLS-1$ //$NON-NLS-2$
			// U+21B5 NEW -->
			{ "lArr", "8656" }, // leftwards double arrow, U+21D0 ISOtech --> //$NON-NLS-1$ //$NON-NLS-2$
			// <!-- ISO 10646 does not say that lArr is the same as the 'is implied by' arrowbut
			// also does not have any other character for that function. So ? lArr canbe used for
			...
			{ "sum", "8721" }, // n-ary summation, U+2211 ISOamsb --> //$NON-NLS-1$ //$NON-NLS-2$
			...
			{ "rsaquo", "8250" }, // single right-pointing angle quotation mark,U+203A ISO //$NON-NLS-1$ //$NON-NLS-2$
			// proposed -->
	...
	static class PrimitiveEntityMap implements EntityMap
	{
		...
		/**
		 * @see com.aptana.ide.editors.unified.utils.Entities.EntityMap#value(java.lang.String)
		 */
