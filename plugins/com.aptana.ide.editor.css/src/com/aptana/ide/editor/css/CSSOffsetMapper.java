...
/**
 */
public class CSSOffsetMapper extends ChildOffsetMapper
{
	...
	public static final String MODE_NORMAL = "MODE_NORMAL"; //$NON-NLS-1$

	/** We are "inside" a rule */
	public static final String MODE_INVOKING = "MODE_INVOKING"; //$NON-NLS-1$
	...
	public String getMode(int offset)
	{
		...
		// backtrack over lexemes until we find a unmatched : or ;
		...
		while (pos >= 0 && pos < getLexemeList().size())
		{
			...
			{
				case CSSTokenTypes.COLON: // this needs to be a
