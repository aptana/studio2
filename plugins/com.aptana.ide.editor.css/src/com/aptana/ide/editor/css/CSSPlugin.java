...
public class CSSPlugin extends AbstractUIPlugin
{
	 ...
	 * The plug-in ID
	 */
	public static final String ID = "com.aptana.ide.editor.css"; //$NON-NLS-1$
	...
	{
		return AbstractUIPlugin.imageDescriptorFromPlugin("com.aptana.ide.editor.css", path); //$NON-NLS-1$
	}
}
