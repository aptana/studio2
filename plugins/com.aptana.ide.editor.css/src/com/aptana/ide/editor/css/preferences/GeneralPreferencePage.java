...
public class GeneralPreferencePage extends CoreEditorPreferencePage
{
	...
	public void createFieldEditors()
	{
		...
		addField(new BooleanFieldEditor(IPreferenceConstants.SHOW_CSS_TOOLBAR, Messages.GeneralPreferencePage_DisplayCSSToolbar,
	...
	{
		return Messages.GeneralPreferencePage_CSSDescription;
	}
	...
	{
		return "com.aptana.ide.editors.CSSEditor"; //$NON-NLS-1$
	}
	...
	{
		return CSSPlugin.getImageDescriptor("images/css_file.png"); //$NON-NLS-1$
	}
