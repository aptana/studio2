...
public class FoldingPreferencePage extends com.aptana.ide.editors.preferences.FoldingPreferencePage
{
	...
	{
		this.addInitialFoldingField(getLanguage(), "ruleset", Messages.FoldingPreferencePage_FoldSelectors); //$NON-NLS-1$
		this.addInitialFoldingField(getLanguage(), "COMMENT", Messages.FoldingPreferencePage_FoldComments); //$NON-NLS-1$
	}
