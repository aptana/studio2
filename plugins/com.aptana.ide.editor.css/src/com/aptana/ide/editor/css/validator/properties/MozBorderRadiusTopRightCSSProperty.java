 ...
 */
public class MozBorderRadiusTopRightCSSProperty extends
        MozBorderRadiusSideProperty
{
    /**
     * Property name.
     */
    private static String PROPERTY_NAME = "-moz-border-radius-topright"; //$NON-NLS-1$

    /**
     * MozBorderRadiusTopRightCSSProperty constructor.
     */
