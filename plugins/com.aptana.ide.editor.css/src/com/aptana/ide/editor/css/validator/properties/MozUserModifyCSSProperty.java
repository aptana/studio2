...
public class MozUserModifyCSSProperty extends CSSFixedSetProperty
{
    ...
    private static final String[] VALUES 
        = new String[]{"inherit", "read-only", "read-write", "write-only"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
     ...
     * @throws InvalidParamException IF expression is invalid
     */
    public MozUserModifyCSSProperty(ApplContext context, CssExpression expression)
            throws InvalidParamException {
