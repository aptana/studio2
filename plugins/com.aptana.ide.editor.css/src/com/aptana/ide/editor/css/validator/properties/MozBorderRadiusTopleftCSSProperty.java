 ...
 */
public class MozBorderRadiusTopleftCSSProperty extends
        MozBorderRadiusSideProperty
{
    /**
     * Property name.
     */
    private static String PROPERTY_NAME = "-moz-border-radius-topleft"; //$NON-NLS-1$

    /**
     * MozBorderRadiusTopleftCSSProperty constructor.
     */
