...
public class CodeAssistPreferencePage extends com.aptana.ide.editors.preferences.CodeAssistPreferencePage
{
	...
	public void createFieldEditors()
	{
		...
		addField(new BooleanFieldEditor(IPreferenceConstants.CSSEDITOR_INSERT_COLON,
				Messages.GeneralPreferencePage_AutomaticallyInsertColon, group));

		addField(new BooleanFieldEditor(IPreferenceConstants.CSSEDITOR_INSERT_SEMICOLON,
				Messages.GeneralPreferencePage_AutomaticallyInsertSemicolon, group));
