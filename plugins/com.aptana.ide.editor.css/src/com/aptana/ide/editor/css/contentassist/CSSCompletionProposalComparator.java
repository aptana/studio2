 ...
 * Sorts
 */
public class CSSCompletionProposalComparator implements Comparator
{
	...
	{
		if (o1 instanceof CSSCompletionProposal && o2 instanceof CSSCompletionProposal)
		{
			CSSCompletionProposal cp1 = (CSSCompletionProposal) o1;
			CSSCompletionProposal cp2 = (CSSCompletionProposal) o2;
