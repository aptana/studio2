 ...
 * 
 */
public class CSSCompletionProposal extends UnifiedCompletionProposal
{
	/**
	 ...
	 */
	public CSSCompletionProposal(String replacementString, int replacementOffset, int replacementLength,
