 ...
 */
public class CSSParseNode extends ParseNodeBase
{
	/**
	...
	static
	{
		Empty = new CSSParseNode(CSSParseNodeTypes.EMPTY, null);
	 ...
	 * @param startLexeme
	 */
	public CSSParseNode(int typeIndex, Lexeme startLexeme)
	{
		super(typeIndex, CSSMimeType.MimeType, startLexeme);
	}
