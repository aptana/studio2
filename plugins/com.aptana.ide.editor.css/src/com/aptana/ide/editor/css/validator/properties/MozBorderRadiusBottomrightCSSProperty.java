 ...
 */
public class MozBorderRadiusBottomrightCSSProperty extends
        MozBorderRadiusSideProperty
{
    /**
     * Property name.
     */
    private static String PROPERTY_NAME = "-moz-border-radius-bottomright"; //$NON-NLS-1$

    /**
     * MozBorderRadiusBottomrightCSSProperty constructor.
     */
    ...
    public MozBorderRadiusBottomrightCSSProperty(
            ...
            throws InvalidParamException
    {
        super (PROPERTY_NAME, context, expression);
    }
}
