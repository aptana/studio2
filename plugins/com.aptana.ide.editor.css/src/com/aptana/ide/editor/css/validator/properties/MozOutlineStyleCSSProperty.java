...
public class MozOutlineStyleCSSProperty extends CSSFixedSetProperty
{
    ...
    private static final String[] VALUES 
        = new String[]{"inherit", "none", "dotted", "dashed", "solid",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
     ...
     * @throws InvalidParamException IF expression is invalid
     */
    public MozOutlineStyleCSSProperty(ApplContext context, CssExpression expression)
            throws InvalidParamException {
