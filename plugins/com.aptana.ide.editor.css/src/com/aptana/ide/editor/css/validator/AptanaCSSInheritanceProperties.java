...
public class AptanaCSSInheritanceProperties {
	 ...
	 * Properties utils.
	 */
	private static Utf8Properties properties;
	...
	static 
	{
		try 
		{
		   ...
		   IdeLog.logError(AptanaCorePlugin.getDefault(), "Failed loading properties: " //$NON-NLS-1$
				   + PROPERTIES_FILE, e);
		}
    }

    /**
     * Gets property inheritance.
     * @param property - property.
     * @return
     */
    public static boolean getInheritance(CssProperty property) {
    	String res = 
    		properties.getProperty(property.getPropertyName() + "." + INHERITED); //$NON-NLS-1$
    	return Boolean.parseBoolean(res);
    }
    
    /**
     * AptanaCSSInheritanceProperties private constructor.
     */
