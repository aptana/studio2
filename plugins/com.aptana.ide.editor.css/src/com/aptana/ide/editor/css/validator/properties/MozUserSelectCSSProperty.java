...
public class MozUserSelectCSSProperty extends CSSFixedSetProperty {
	...
	private static final String[] VALUES 
		= new String[]{"inherit", "none", "text", "element", "elements",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	 ...
	 * @throws InvalidParamException IF expression is invalid
	 */
	public MozUserSelectCSSProperty(ApplContext context, CssExpression expression)
			throws InvalidParamException {
