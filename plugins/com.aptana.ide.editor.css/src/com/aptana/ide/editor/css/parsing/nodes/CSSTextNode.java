 ...
 */
public class CSSTextNode extends CSSParseNode
{
	 ...
	 * getText
	 * 
	 * @return Returns this node's text value
	 */
	...
	{
		super(CSSParseNodeTypes.TEXT, startLexeme);
		
		this._text = startLexeme.getText();
		this.setAttribute("value", this._text); //$NON-NLS-1$
	}
