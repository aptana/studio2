...
/**
 * Property, which value can be of the several size-related types,
 * or one from the fixed set.
...
public abstract class SizeOrFixedCSSProperty extends TypeOrFixedCSSProperty
{
     ...
     * Array of converters.
     */
    private static CSSValueTypeConverter[] CONVERTERS_ARRAY 
        = new CSSValueTypeConverter[]{new NumberToLenghtConverter()};
    
    

    /**
     * SizeOrFixedCSSProperty constructor.
     */
     ...
     */
    public SizeOrFixedCSSProperty(String propertyName, String[] values,
            ApplContext context, CssExpression expression, boolean check)
            throws InvalidParamException
    {
        super(propertyName, 
                new Class[]{CssLength.class, CssNumber.class},
                CONVERTERS_ARRAY, values, context, expression, check);
    }
