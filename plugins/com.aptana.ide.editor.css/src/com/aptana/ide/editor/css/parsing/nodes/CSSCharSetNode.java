 ...
 */
public class CSSCharSetNode extends CSSParseNode
{
	/**
	 * @param startLexeme
	 */
	public CSSCharSetNode(Lexeme startLexeme)
	{
		super(CSSParseNodeTypes.CHAR_SET, startLexeme);
	}
	...
	{
		writer.printWithIndent("@charset "); //$NON-NLS-1$
