 ...
 */
public class CSSContentAssistProcessorFactory implements IContentAssistProcessorFactory
{
	private static CSSContentAssistProcessorFactory instance;
	...
	{
		return new CSSContentAssistProcessor(fileContext);
	}
	...
	public static CSSContentAssistProcessorFactory getInstance()
	{
		if (instance == null)
		{
			instance = new CSSContentAssistProcessorFactory();
		}
		return instance;
	}
}
