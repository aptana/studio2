...
public class MozUserFocusCSSProperty extends CSSFixedSetProperty
{
    ...
    private static final String[] VALUES 
        = new String[]{"inherit", "auto", "normal", "none", "ignore"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
     ...
     * @throws InvalidParamException IF expression is invalid
     */
    public MozUserFocusCSSProperty(ApplContext context, CssExpression expression)
            throws InvalidParamException {
