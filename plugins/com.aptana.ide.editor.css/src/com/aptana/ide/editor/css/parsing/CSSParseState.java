...
import com.aptana.ide.editor.css.parsing.nodes.CSSParseNodeFactory;
 ...
 */
public class CSSParseState extends ParseStateChild
{
	/**
	...
	{
		super(CSSMimeType.MimeType, parent);
	}
	...
	{
		return new CSSParseNodeFactory(this);
	}
}
