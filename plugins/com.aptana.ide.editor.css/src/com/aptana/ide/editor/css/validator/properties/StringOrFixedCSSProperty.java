...
public abstract class StringOrFixedCSSProperty extends TypeOrFixedCSSProperty
{
    ...
    /**
     * StringOrFixedCSSProperty constructor.
     */
     ...
     */
    public StringOrFixedCSSProperty(String propertyName, String[] values,
            ApplContext context, CssExpression expression, boolean check)
            throws InvalidParamException
    {
        super(propertyName, new Class[]{CssIdent.class},
                null, values, context, expression, check);
    }
