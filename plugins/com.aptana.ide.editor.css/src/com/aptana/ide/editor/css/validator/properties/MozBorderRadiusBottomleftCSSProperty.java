 ...
 */
public class MozBorderRadiusBottomleftCSSProperty extends
        MozBorderRadiusSideProperty
{
     ...
     * Property name.
     */
    private static String PROPERTY_NAME = "-moz-border-radius-bottomleft"; //$NON-NLS-1$

    /**
     * MozBorderRadiusBottomleftCSSProperty constructor.
     */
