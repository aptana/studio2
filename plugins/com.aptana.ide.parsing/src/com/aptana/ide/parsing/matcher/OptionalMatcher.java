 ...
 */
public class OptionalMatcher extends AbstractLexemeMatcher
{
	/**
	 * OptionalMatcher
	 */
	...
	public void addChildTypes()
	{
		...
		this.addChildType(UseRuleMatcher.class);
	}
	...
	{
		int result = offset;
		ILexemeMatcher child = null;
		
		this.reset();
		
		if (this.getChildCount() > 0)
		{
			child = (ILexemeMatcher) this.getChild(0);
		}
		
		if (child != null)
		{
			result = child.match(lexemes, offset, eofOffset);
			...
			{
				this.addChildParseNode(child.getParseResults());
			}
		}
