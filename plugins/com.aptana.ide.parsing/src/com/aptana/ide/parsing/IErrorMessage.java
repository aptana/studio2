...
{
	/**
	 * Gets the range where the error occurred in the source document
	 * 
	 * @return Returns the range where this error occurred
	 */
	...
	/**
	 * Set the error list to which this error node belongs
	 * 
	 * @param owningList
	 *            The new owner of this error node
	 */
	void setOwningList(ErrorList owningList);
