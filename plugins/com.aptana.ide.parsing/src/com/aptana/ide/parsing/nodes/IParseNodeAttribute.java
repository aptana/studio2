...
public interface IParseNodeAttribute
{
	...
	/**
	 * Get the type of quote used to display this attribute's value
	 * 
	 * @return int
	 */
	int getQuoteType();
	...
	/**
	 * Set the type of quote used to display this attribute's value
	 * 
	 * @param quoteType
	 */
	void setQuoteType(int quoteType);
