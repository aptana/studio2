 ...
 */
public interface ICodeBasedTokenList extends ITokenList
{
	/**
	 * find
	 * 
	 ...
	 * @param startingPosition
	 * @param eofOffset
	 * @return The final position of the failed or successful match
	 */
	 ...
	 * 
	 * @return The index of the last matching token or -1 if there was no match
	 */
