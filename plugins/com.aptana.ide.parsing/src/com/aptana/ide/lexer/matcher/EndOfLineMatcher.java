 ...
 */
public class EndOfLineMatcher extends AbstractTextMatcher
{
	...
	public int match(char[] source, int offset, int eofOffset)
	{
		...
		if ((offset >= eofOffset || source[offset] == '\r' || source[offset] == '\n') != this._negate)
		{
			result = offset;
		}
