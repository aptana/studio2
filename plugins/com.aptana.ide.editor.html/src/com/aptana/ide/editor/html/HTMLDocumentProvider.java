 ...
 */
public final class HTMLDocumentProvider extends BaseDocumentProvider
{
	/**
	 * Bundle of all required informations to allow working copy management.
	 */
	protected static class HTMLFileInfo extends FileInfo
	{
		/**
		 * sourceProvider
		 */
	...
	protected FileInfo createFileInfo(Object element) throws CoreException
	{
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.HTMLDocumentProvider_CantCreateFileInfo, ex);
		}
		return null;
	}
	...
	{
		HTMLFileInfo cuInfo = (HTMLFileInfo) getFileInfo(element);
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.HTMLDocumentProvider_ErrorDisconnectingDocumentProvider, ex);
		}
	}
