...
public class HTMLDocumentType
{
	 ...
	 */
	public static final int XHTML_1_0_STRICT = 6;
	
	/**
	 * XHTML 1.0 transitional document type
	 */
	public static final int XHTML_1_0_TRANSITIONAL = 7;
	
	/**
	 * XHTML 1.0 frameset document type
	 */
	public static final int XHTML_1_0_FRAMESET = 8;
	
	/**
	 * XHTML 1.1 strict document type
	 */
	public static final int XHTML_1_1_STRICT = 9;
}
