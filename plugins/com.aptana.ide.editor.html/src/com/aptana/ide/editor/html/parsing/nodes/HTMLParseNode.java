 ...
 */
public class HTMLParseNode extends ParseNodeBase
{
	/**
	 * HTMLParseNode
	 * 
	 ...
	 * @param startLexeme
	 */
	public HTMLParseNode(int typeIndex, Lexeme startLexeme)
	{
		super(typeIndex, HTMLMimeType.MimeType, startLexeme);
	}
}
