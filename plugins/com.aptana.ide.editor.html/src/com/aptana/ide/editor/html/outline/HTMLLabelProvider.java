 ...
 */
public class HTMLLabelProvider extends LabelProvider implements IPropertyChangeListener
{
	private static final Image ELEMENT_ICON = HTMLPlugin.getImage("icons/element_icon.gif"); //$NON-NLS-1$
	private static final Image WARNING_ICON = UnifiedEditorsPlugin.getImage("icons/warning.png"); //$NON-NLS-1$
	private static final Image ERROR_ICON = UnifiedEditorsPlugin.getImage("icons/error.png"); //$NON-NLS-1$
	...
	private void getAttributeNameList()
	{
		...
		String result = prefStore.getString(IPreferenceConstants.HTMLEDITOR_OUTLINER_ATTRIBUTE_LIST);
	...
	public Image getImage(Object element)
	{
		...
		{
			HTMLSpecialNode node = (HTMLSpecialNode) element;

			result = HTMLPlugin.getImage("icons/" + node.getIconBaseName() + ".gif"); //$NON-NLS-1$ //$NON-NLS-2$
		}
		else
		{
	...
	public String getText(Object element)
	{
		...
		if (element instanceof HTMLElementNode)
		{
			HTMLElementNode node = (HTMLElementNode) element;
			result = node.getName();
		...
		{
			result = ((HTMLSpecialNode) element).getText();
		}
		else
		{
