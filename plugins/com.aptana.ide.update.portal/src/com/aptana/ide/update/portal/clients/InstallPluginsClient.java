 ...
 */
public class InstallPluginsClient extends CometResponderClient
{

	/**
	 * INSTALL_PLUGIN
	 */
	public static final String INSTALL_PLUGIN = "/portal/plugins/install"; //$NON-NLS-1$
	...
	protected Object getResponse(String toChannel, Object request)
	{
		...
		{
			final String pluginId = (String) request;
			UIJob job = new UIJob(Messages.InstallPluginsClient_InstallerJob_Title)
			{

				public IStatus runInUIThread(IProgressMonitor monitor)
				{
					PluginsManager.install(pluginId);
	...
	{
		return new String[] { INSTALL_PLUGIN };
	}
