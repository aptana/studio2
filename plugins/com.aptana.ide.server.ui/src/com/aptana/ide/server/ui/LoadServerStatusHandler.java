...
public class LoadServerStatusHandler implements IStatusHandler
{
	...
	public Object handleStatus(final IStatus status, final Object source) throws CoreException
	{
		...
		default1.asyncExec(new Runnable()
		{
			...
			public void run()
			{
				...
				MessageDialog
						.openError(
								default1.getActiveShell(),
								StringUtils.format(Messages.LoadServerStatusHandler_HANDLE_SERVER_LOAD_ERROR_TITLE,
										source.toString()),
								StringUtils
										.format(
												Messages.LoadServerStatusHandler_Description, new String[] { source.toString(), exception.getClass().getName(), exception 
