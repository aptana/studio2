...
public class ServerUIPlugin extends AbstractUIPlugin
{
	 ...
	 * ID
	 */
	public static final String ID = "com.aptana.ide.server.ui"; //$NON-NLS-1$
	// The shared instance.
	...
	{
		return AbstractUIPlugin.imageDescriptorFromPlugin("com.aptana.ide.server.ui", path); //$NON-NLS-1$
	}
