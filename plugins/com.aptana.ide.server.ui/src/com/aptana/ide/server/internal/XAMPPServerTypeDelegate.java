 ...
 */
public class XAMPPServerTypeDelegate implements IServerTypeDelegate
{

	/**
	 * ID
	 */
	public static final String ID = "com.aptana.ide.server.xampp"; //$NON-NLS-1$

	/**
	 * STOPPATH
	 */
	public static final String STOPPATH = "stoppath"; //$NON-NLS-1$
	...
	{
		return new XAMPPServer(type, configuration);
	}
