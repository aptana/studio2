...
{
	private static final String BUNDLE_NAME = "com.aptana.ide.core.io.ingo.messages";//$NON-NLS-1$

	public static String VirtualFileManagerSyncPair_UnableToLoadSyncConfiguration = null;

	public static String VirtualFileManagerSyncPair_UnableToSerializeSyncPair = null;
