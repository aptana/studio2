 ...
 */
public class JSLabelNode extends JSParseNode
{
	/**
	 * JSLabelNode
	 * 
	 ...
	 * @param startLexeme
	 */
	public JSLabelNode(int typeIndex, Lexeme startLexeme)
	{
	...
	public void getSource(SourceWriter writer)
	{
		switch (this.getTypeIndex())
		{
			case JSParseNodeTypes.BREAK:
				writer.print("break"); //$NON-NLS-1$
				break;
				
			case JSParseNodeTypes.CONTINUE:
				writer.print("continue"); //$NON-NLS-1$
				break;
		...
		JSParseNode child = (JSParseNode) this.getChild(0);
