 ...
 */
public class JSBooleanConstructor extends NativeConstructorBase
{
	/*
	 * Constructors
	 */
	 ...
	 *            The environment in which this native boolean was created
	 */
	public JSBooleanConstructor(Environment owningEnvironment)
	{
		...
		global.putPropertyValue("Boolean", this, fileIndex, Property.DONT_DELETE | Property.DONT_ENUM); //$NON-NLS-1$
	...
	{
		// Create new instance
		JSBoolean instance = new JSBoolean(sourceRegion);
	...
	{
		return environment.createBoolean(fileIndex, sourceRegion);
	}
}
