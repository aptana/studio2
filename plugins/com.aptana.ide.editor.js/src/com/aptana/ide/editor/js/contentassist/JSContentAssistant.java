 ...
 */
public final class JSContentAssistant // extends ContentAssistant
{
	private static boolean hotkeyActivated = false;

	/**
	 * Content assist base for JS.
	 */
	private JSContentAssistant()
	{
	}

	/**
	 * @return Returns the hotkeyActivated.
	 */
	...
	/**
	 * @param hotkeyActivated The hotkeyActivated to set.
	 */
	public static void setHotkeyActivated(boolean hotkeyActivated)
	{
		JSContentAssistant.hotkeyActivated = hotkeyActivated;
	}
}
