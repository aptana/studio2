...
public class GeneralPreferencePage extends CoreEditorPreferencePage
{
	...
	public void createFieldEditors()
	{
		...
		addField(new BooleanFieldEditor(IPreferenceConstants.SHOW_JS_TOOLBAR, Messages.GeneralPreferencePage_DisplayJSToolbar,
	...
	{
		return Messages.GeneralPreferencePage_JavaScriptDescription;
	}
	...
	{
		return "com.aptana.ide.editors.JSEditor"; //$NON-NLS-1$
	}
	...
	{
		return JSPlugin.getImageDescriptor("images/js_file.png"); //$NON-NLS-1$
	}
