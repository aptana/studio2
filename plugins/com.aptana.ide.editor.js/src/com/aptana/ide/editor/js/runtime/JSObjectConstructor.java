 ...
 */
public class JSObjectConstructor extends NativeConstructorBase
{
	/*
	 * Constructors
	 */
	...
	/**
	 * Create a new instance of NativeObject
	 * 
	 * @param owningEnvironment
	 *            The environment in which this native object was created
	 */
	public JSObjectConstructor(Environment owningEnvironment)
	{
		...
		global.putPropertyValue("Object", this, fileIndex, Property.DONT_DELETE | Property.DONT_ENUM); //$NON-NLS-1$

		// NOTE: We can't set object's [[prototype]] here since
		// Function.prototype has not been created yet. We'll set [[prototype]]
		// later in initialize properties
	...
	public void initializeProperties()
	{
		...
		// Note that we set object's [[prototype]] here since Function.prototype
		// didn't exist when we called this class' constructor

		// set Object.[[prototype]]
		this.setPrototype(environment.getGlobal().getPropertyValue("Function", fileIndex, offset).getPropertyValue( //$NON-NLS-1$
				"prototype", fileIndex, offset)); //$NON-NLS-1$
		...
		prototype.putPropertyValue("hasOwnProperty", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("isPrototypeOf", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("propertyIsEnumerable", environment.createFunction(fileIndex, Range.Empty), fileIndex, //$NON-NLS-1$
				attributes);
	}
	...
	{
		// Create new instance
		JSObject instance = new JSObject(sourceRegion);
	...
	{
		return environment.createObject(fileIndex, sourceRegion);
	}
}
