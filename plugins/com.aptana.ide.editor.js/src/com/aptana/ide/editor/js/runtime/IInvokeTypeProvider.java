...
public interface IInvokeTypeProvider
{
	 ...
	 * 
	 * @param environment
	 *            The current JS runtime environment
	 * @param arguments
	 *            The arguments passed to this invocation
	 * @param fileIndex
	 *            The index of the file where this invocation is taking place
	 * @param sourceRegion
	 *            The region of the file where this invocation is being made
	 * @return Returns the result of this invocation.
	 */
