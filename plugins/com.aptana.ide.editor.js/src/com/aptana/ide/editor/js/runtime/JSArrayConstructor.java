 ...
 */
public class JSArrayConstructor extends NativeConstructorBase
{
	/*
	 * Constructors
	 */
	 ...
	 *            The environment in which this native array was created
	 */
	public JSArrayConstructor(Environment owningEnvironment)
	{
		...
		global.putPropertyValue("Array", this, fileIndex, Property.DONT_DELETE | Property.DONT_ENUM); //$NON-NLS-1$
	...
	public void initializeProperties()
	{
		...
		prototype.putPropertyValue("join", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("pop", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("push", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("reverse", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("shift", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("slice", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("sort", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("splice", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("unshift", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
	}
	...
	public IObject construct(Environment environment, IObject[] arguments, int fileIndex, IRange sourceRegion)
	{
		...
		// Create new instance
		JSArray instance = new JSArray(sourceRegion);
	...
	{
		return environment.createArray(fileIndex, sourceRegion);
	}
}
