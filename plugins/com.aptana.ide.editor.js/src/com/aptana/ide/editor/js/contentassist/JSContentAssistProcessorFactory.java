 ...
 */
public class JSContentAssistProcessorFactory implements IContentAssistProcessorFactory
{
	private static JSContentAssistProcessorFactory instance;
	...
	{
		return new JSContentAssistProcessor(fileContext);
	}
	...
	public static JSContentAssistProcessorFactory getInstance()
	{
		if (instance == null)
		{
			instance = new JSContentAssistProcessorFactory();
		}
		return instance;
	}
}
