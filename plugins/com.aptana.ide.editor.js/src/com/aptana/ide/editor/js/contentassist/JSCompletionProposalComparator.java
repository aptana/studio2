 ...
 * Sorts
 */
public class JSCompletionProposalComparator implements Comparator<ICompletionProposal>
{
	...
	{
		int result = cp1.getDisplayString().compareToIgnoreCase(cp2.getDisplayString());

		if (result == 0)
		{
			result = cp1.getDisplayString().compareTo(cp2.getDisplayString());
		}
