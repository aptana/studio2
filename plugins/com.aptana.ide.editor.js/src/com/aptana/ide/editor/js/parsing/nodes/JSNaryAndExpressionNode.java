...
public class JSNaryAndExpressionNode extends JSNaryNode
{
	 ...
	 * @param startLexeme
	 */
	public JSNaryAndExpressionNode(int typeIndex, Lexeme startLexeme)
	{
		super(typeIndex, startLexeme);
	}

	/**
	 * @see com.aptana.ide.editor.js.parsing.nodes.JSNaryNode#getSource(com.aptana.ide.io.SourceWriter)
	 */
	public void getSource(SourceWriter writer)
	{
		JSParseNode expression = (JSParseNode) this.getChild(0);
		
		switch (this.getTypeIndex())
		{
			case JSParseNodeTypes.CASE:
				writer.print("case "); //$NON-NLS-1$
				expression.getSource(writer);
