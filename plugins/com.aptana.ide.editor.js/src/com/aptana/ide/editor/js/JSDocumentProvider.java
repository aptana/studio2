 ...
 */
public final class JSDocumentProvider extends BaseDocumentProvider
{
	/**
	 * Bundle of all required informations to allow working copy management.
	 */
	protected static class JSFileInfo extends FileInfo
	{
		/**
		 * sourceProvider
		 */
	...
	private static JSDocumentProvider _unifiedDocumentProvider = null;
	...
	public static JSDocumentProvider getInstance()
	{
		...
		{
			_unifiedDocumentProvider = new JSDocumentProvider();
		}

		return _unifiedDocumentProvider;
	}

	private JSDocumentProvider()
	{
	}
	...
	protected FileInfo createFileInfo(Object element) throws CoreException
	{
		...
		try
		{
			...
			if (!(info instanceof JSFileInfo))
			{
				return null;
			}
			
			JSFileInfo cuInfo = (JSFileInfo)info;
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.JSDocumentProvider_CantCreateFileInfo, ex);
		}
		return null;
	}
	...
	{
		JSFileInfo cuInfo = (JSFileInfo) getFileInfo(element);
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.JSDocumentProvider_ErrorDisconnectingDocumentProvider, ex);
		}
	}
