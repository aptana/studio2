 ...
 */
public class JSNumberConstructor extends NativeConstructorBase
{
	/*
	 * Constructors
	 */
	 ...
	 *            The environment in which this native number was created
	 */
	public JSNumberConstructor(Environment owningEnvironment)
	{
		...
		global.putPropertyValue("Number", this, fileIndex, Property.DONT_DELETE | Property.DONT_ENUM); //$NON-NLS-1$
	...
	public void initializeProperties()
	{
		...
		this.putPropertyValue("MAX_VALUE", environment.createNumber(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		this.putPropertyValue("MIN_VALUE", environment.createNumber(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		this.putPropertyValue("NaN", environment.createNumber(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		this.putPropertyValue("NEGATIVE_INFINITY", environment.createNumber(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		this.putPropertyValue("POSITIVE_INFINITY", environment.createNumber(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		...
		prototype.putPropertyValue("toFixed", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("toExponential", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
		prototype.putPropertyValue("toPrecision", environment.createFunction(fileIndex, Range.Empty), fileIndex, attributes); //$NON-NLS-1$
	}
	...
	{
		// Create new instance
		JSNumber instance = new JSNumber(sourceRegion);
