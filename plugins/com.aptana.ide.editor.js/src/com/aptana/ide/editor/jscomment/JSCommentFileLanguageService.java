 ...
 */
public class JSCommentFileLanguageService extends BaseFileLanguageService
{
	 ...
	 * @param mapper
	 */
	public JSCommentFileLanguageService(
	...
	{
		return getParseState(JSCommentMimeType.MimeType);
	}
	 ...
	 * 
	 * @param context
	 * @return JSCommentFileLanguageService
	 */
	public static JSCommentFileLanguageService getScriptDocFileLanguageService(IFileService context){
		JSCommentFileLanguageService languageService = (JSCommentFileLanguageService)context.getLanguageService(JSCommentMimeType.MimeType);
		if(languageService == null)
		{
			throw new IllegalStateException(Messages.JSCommentFileLanguageService_NoCommentLanguageService);
		}
