...
public class AddRepositoryStartup implements IStartup
{
	...
	private static final VersionRange versionRange = new VersionRange("2.0.0"); //$NON-NLS-1$
	...
	public void earlyStartup()
	{
		...
		try
		{
			...
			{
				IPluginManager pluginManager = com.aptana.ide.update.Activator.getDefault().getPluginManager();
