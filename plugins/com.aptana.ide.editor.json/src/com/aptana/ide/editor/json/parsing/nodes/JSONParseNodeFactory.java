 ...
 */
public class JSONParseNodeFactory extends ParseNodeFactory
{
	/**
	 ...
	 */
	public JSONParseNodeFactory(IParseState owningParseState)
	{
	 ...
	 */
	public IParseNode createParseNode(int nodeType, Lexeme startingLexeme)
	{
		...
		switch (nodeType)
		{
			...
			case JSONParseNodeTypes.NAME_VALUE_PAIR:
				result = new JSONParseNode(nodeType, startingLexeme);
				break;
				
			default:
				throw new IllegalArgumentException(Messages.getString("JSONParseNodeFactory.Unknown_Node_Type") + nodeType); //$NON-NLS-1$
		}
