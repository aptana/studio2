...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.aptana.ide.editor.json"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		...
		CoreUIUtils.registerFileExtension("com.aptana.ide.editor.text", "*", "json"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
