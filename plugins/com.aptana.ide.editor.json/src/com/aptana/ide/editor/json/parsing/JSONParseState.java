...
import com.aptana.ide.editor.json.parsing.nodes.JSONParseNodeFactory;
 ...
 */
public class JSONParseState extends ParseStateChild
{
	/**
	 * JSONParseState
	 */
	 ...
	 * @param parent
	 */
	public JSONParseState(IParseState parent)
	{
		super(JSONMimeType.MimeType, parent);
	}
