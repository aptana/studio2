 ...
 */
public class XMLUntitledTextFileWizard extends UntitledTextFileWizard
{
	/**
	...
	protected String getEditorId(File file)
	{
		if (file != null)
		{
			try
			{
				IEditorDescriptor desc = IDE.getEditorDescriptor(file.getName(), false);
				if (desc != null)
					return desc.getId();
			}
		...
		return "com.aptana.ide.editors.XMLEditor";
	}
	...
	/**
	 * @return The initial file contents
