 ...
 */
public final class XMLDocumentProvider extends BaseDocumentProvider
{
	/**
	 * Bundle of all required informations to allow working copy management.
	 */
	protected static class XMLFileInfo extends FileInfo
	{
		/**
		 * sourceProvider
		 */
	...
	private static XMLDocumentProvider _unifiedDocumentProvider = null;
	...
	public static XMLDocumentProvider getInstance()
	{
		...
		{
			_unifiedDocumentProvider = new XMLDocumentProvider();
		}
	...
	protected FileInfo createFileInfo(Object element) throws CoreException
	{
		...
		try
		{
			...
			XMLFileInfo cuInfo = (XMLFileInfo)info;
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.XMLDocumentProvider_CantCreateFileInfo, ex);
		}
		return null;
	}
	...
	{
		XMLFileInfo cuInfo = (XMLFileInfo) getFileInfo(element);
		...
		{
			//TODO:
			IdeLog.logError(UnifiedEditorsPlugin.getDefault(), Messages.XMLDocumentProvider_ErrorDisconnectingDocumentProvider, ex);
		}
	}
