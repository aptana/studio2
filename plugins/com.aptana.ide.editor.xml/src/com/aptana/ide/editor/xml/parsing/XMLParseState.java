...
import com.aptana.ide.editor.xml.parsing.nodes.XMLParseNodeFactory;
 ...
 */
public class XMLParseState extends ParseStateChild
{
	/*
	 * Constructors
	 */
	 ...
	 */
	public XMLParseState(IParseState parent)
	{
		super(XMLMimeType.MimeType,parent);
	}
	...
	{
		return new XMLParseNodeFactory(this);
	}
}
