 ...
 */
public interface IProvidingCompletionMetadata
{
	 ...
	 */
	List<ValueMetadata> getFieldMetadataCompletionProposals(ElementMetadata em, FieldMetadata fm, String valuePrefix, String path);
