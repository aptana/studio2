 ...
 * YMLErrorManager
 */
public class YMLErrorManager extends UnifiedErrorManager implements IErrorManager
{
	 ...
	 * @param fileService
	 */
	public YMLErrorManager(FileService fileService)
	{
		super(fileService, YMLMimeType.MimeType);
	}
	...
	{
		if (PluginUtils.isPluginLoaded(YMLPlugin.getDefault()))
		{
