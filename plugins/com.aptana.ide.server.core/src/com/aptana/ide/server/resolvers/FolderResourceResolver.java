 ...
 */
package com.aptana.ide.server.resolvers;
 ...
 */
public class FolderResourceResolver implements IHttpResourceResolver
{
	/*
	 * Fields
	 */
	...
	/**
	 * Create a new instance of FolderResourceResolver
	 * 
	 * @param dir
	 */
	public FolderResourceResolver(File dir)
	{
	...
	public IHttpResource getResource(RequestLineParser requestLine)
	{
		...
		if (file.exists())
		{
			result = new FileHttpResource(file);
		}
