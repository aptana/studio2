/*
 * Menu: Reporting > Standard Project Report
 * Kudos: Paul Colton
...
function main()
{
	var reportTemplate = report.getTemplate("/reporting/standard.html");
	var finalReport = generateReport(reportTemplate);
	var project = report.getSelectedProject();
	if( project != null ) 
	{
		report.createReportView(finalReport, "Standard", project);
	}
}
