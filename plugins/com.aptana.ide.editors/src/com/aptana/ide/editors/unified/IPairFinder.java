...
/**
 * Finds PairMatch for a given position in a document
 * 
...
public interface IPairFinder
{
	 ...
	 * @return - color
	 */
	Color getPairFinderColor();

	/**
	 * Display only the matching pair (not both)
	 * 
	 * @return - true if only display match, false to display both
	 */
	 ...
	 * 
	 * @return - true if shouldn't be display, false otherwise
	 */
