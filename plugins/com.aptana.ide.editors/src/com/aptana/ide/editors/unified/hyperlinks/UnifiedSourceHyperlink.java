 ...
 */
public class UnifiedSourceHyperlink implements IHyperlink
{
	...
	/**
	 * Creates a new source hyperlink
	 * 
	 * @param service -
	 *            service to find code locations
	 * @param lexeme -
	 *            lexeme of underlying hyperlink
	 * @param region -
	 *            region of hyperlink
	 * @param text -
	 *            text of hyperlink
	...
	public void open()
	{
		if (this.service == null || lexeme == null)
		{
			return;
		}
		String mimetype = lexeme.getLanguage();
		...
		CodeLocation loc = (CodeLocation) langMapper.findTarget(lexeme);
		if (loc != null)
		{
	...
	private void openInEditor(String fileName, Lexeme lexeme)
	{
		...
		if (file.exists())
		{
			IEditorPart part = EditorHelper.openInEditor(file);
