...
public interface ICompletionProposalContributor {
	 ...
	 * @return An array of completion proposals, or null if not valid
	 */
	ICompletionProposal[] computeCompletionProposals(ITextViewer viewer, int offset, int position, LexemeList lexemeList, char activationChar, char previousChar, boolean autoActivated);
}
