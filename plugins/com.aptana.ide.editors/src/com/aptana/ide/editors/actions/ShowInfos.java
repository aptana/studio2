 ...
 */
public class ShowInfos extends BaseAction implements
	...
	public ImageDescriptor getImageDescriptor() {
		return UnifiedEditorsPlugin.getImageDescriptor("icons/information.png"); //$NON-NLS-1$
	}
	...
	public String getText() {
		return Messages.ShowInfos_TEXT;
	}
	...
	private static boolean state = UnifiedEditorsPlugin.getDefault()
			.getPreferenceStore().getBoolean(IPreferenceConstants.SHOW_INFOS);
