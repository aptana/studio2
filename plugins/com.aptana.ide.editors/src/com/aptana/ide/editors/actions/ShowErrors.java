 ...
 */
public class ShowErrors extends BaseAction implements
		IWorkbenchWindowActionDelegate, IViewActionDelegate {

	// TODO: get default state from somewhere
	private static boolean state = UnifiedEditorsPlugin.getDefault()
			.getPreferenceStore().getBoolean(IPreferenceConstants.SHOW_ERRORS);
	...
	public ImageDescriptor getImageDescriptor() {
		return UnifiedEditorsPlugin.getImageDescriptor("icons/error.png"); //$NON-NLS-1$
	}
	...
	public String getText() {
		return Messages.ShowErrors_TEXT;
	}
