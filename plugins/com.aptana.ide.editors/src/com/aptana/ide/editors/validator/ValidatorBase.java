...
/**
 * Abstract class to shield extending classes from future changes in the IValidator
 * 
 * @author Samir Joshi
 */
...
{
	/**
	 * @see IValidator#parseForErrors(String, String, IFileSourceProvider, boolean, boolean, boolean)
	 */
	public abstract IFileError[] parseForErrors(String path, String source, IFileSourceProvider sourceProvider,
