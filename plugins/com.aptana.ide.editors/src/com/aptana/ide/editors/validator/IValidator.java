...
/**
 * Specifies contract to be implemented by source validators
 * 
 * @author Samir Joshi
 *
 */
public interface IValidator
{
	 ...
	 * @param collectInfos
	 * @return Array of error/warning/information items as result of validation 
	 */
	 IFileError[] parseForErrors(String path, String source, IFileSourceProvider sourceProvider, 
