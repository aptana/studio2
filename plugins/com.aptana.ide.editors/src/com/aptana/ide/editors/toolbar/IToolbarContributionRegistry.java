...
/**
 * interface to access editor toolbar contribution registry
 * @author Pavel Petrochenko
 */
public interface IToolbarContributionRegistry
{

	/**
	 * adds contribution to toolbar
	 * @param language
	 * @param contribution
	 */
	...
	/**
	 * removes contribution from toolbar
	 * @param language
	 * @param contribution
	 * @param cont
	 */
	 ...
	 */
	List getContributions(String language);
