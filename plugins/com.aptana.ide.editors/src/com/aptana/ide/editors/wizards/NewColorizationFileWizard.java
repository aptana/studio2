 ...
 *
 */
public class NewColorizationFileWizard extends SimpleNewFileWizard
{
	/**
	 * NewLexerFileWizard
	 */
	public NewColorizationFileWizard()
	{
		super();
		
		this.setWindowTitle(Messages.NewColorizationFileWizard_Window_Title);
	}
	...
	protected SimpleNewWizardPage createNewFilePage(ISelection selection)
	{
		...
		page.setRequiredFileExtensions(new String[] { "col" }); //$NON-NLS-1$
		page.setTitle(Messages.NewColorizationFileWizard_Title);
		page.setDescription(Messages.NewColorizationFileWizard_Description);
		page.setDefaultFileName(Messages.NewColorizationFileWizard_Default_File_Name);
