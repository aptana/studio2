 ...
 * @version
 */
public class EditableDirectoryProperty extends EditableProperty
{
	/**
	 * serialVersionUID
	 */
	 ...
	 * @param name
	 */
	public EditableDirectoryProperty(String ID, String name)
	{
		super(ID, name);
	}
	...
	{
		PropertyDescriptor propertyDescriptor = new DirectoryPropertyDescriptor(getID(), getName());
