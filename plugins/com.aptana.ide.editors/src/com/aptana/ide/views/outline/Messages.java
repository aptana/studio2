...
{
	private static final String BUNDLE_NAME = "com.aptana.ide.views.outline.messages"; //$NON-NLS-1$
	...
	public static String FilterActionInfo_Filter;
    ...
    public static String ScriptdocPreviewPage_Job_RefreshingBrowser;

	public static String SplitOutlinesAction_LBL_SplitView;

	/**
	 * 
	 */
	public static String UnifiedOutlinePage_CollapseAll;

	/**
	 * 
	 */
	public static String UnifiedOutlinePage_ErrorRefreshingOutline;

	/**
	 * 
	 */
	public static String UnifiedOutlinePage_ExpandAll;

	/**
	 * 
	 */
	public static String UnifiedOutlinePage_Open;
	
	/**
	 * UnifiedOutlinePage_Source
	 */
	public static String UnifiedOutlinePage_Source;
	
	/**
	 * UnifiedOutlinePage_Filter
	 */
	public static String UnifiedOutlinePage_Filter;
}
