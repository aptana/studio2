...
/**
 * A generic TableViewer Sorter. Mostly taken from https://bugs.eclipse.org/bugs/show_bug.cgi?id=158112
 * 
 * @author brad
 */
public class TableViewerSorter extends ViewerSorter
{
	...
	/**
	 * Creates a new table viewer sorter
	 * 
	 * @param columnIndex
	 */
	...
	/**
	 * Compares the two objects provided. If numbers are in the relevant string then the objects are returned in number
