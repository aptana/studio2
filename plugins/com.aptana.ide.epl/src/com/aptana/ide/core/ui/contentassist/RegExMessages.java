...
public final class RegExMessages extends NLS
{
	...
	static
	{
		RegExMessages.reloadMessages();
	}

	static void reloadMessages()
	{
		NLS.initializeMessages(RegExMessages.BUNDLE_NAME, RegExMessages.class);
	}
	 ...
	 * 
	 */
    public static String displayString_zeromore;
    
    /**
     * 
     */
    public static String additionalInfo_zeromore;
    
    /**
     * 
     */
    public static String displayString_bs_v;
    
    /**
     * 
     */
    public static String additionalInfo_bs_v;
}
