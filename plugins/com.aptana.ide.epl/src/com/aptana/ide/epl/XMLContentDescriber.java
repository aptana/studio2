...
/**
 * A content interpreter for XML files. This class provides internal basis for XML-based content describers.
 * <p>
 ...
 * @deprecated class was moved to another package between Eclipse 3.4 and 3.5. Once we move to 3.5+ we can remove this copy and point the AIR class to the new location to extend.
 */
