...
public class ToggleCommentAction extends TextEditorAction implements IAction
{
	...
	{
		super(EditorMessages.getBundleForConstructedKeys(), "Editor.ToggleComment.", editor); //$NON-NLS-1$
	}
	...
	private boolean isSelectionCommented(ISelection selection)
	{
		...
		{
			// should not happen
			IdeLog.logError(Activator.getDefault(), x.getMessage(), x);
		}
	...
	protected String[] getDefaultPrefixes(SourceViewerConfiguration configuration, ISourceViewer sourceViewer,
			String type)
	{
