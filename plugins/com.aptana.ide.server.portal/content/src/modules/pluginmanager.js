	...
	_initViews: function _initViews()
	{
        View.load(
        {
			main:
			{
				...
				behaviors: function()
				{
					var pluginTabs = new Control.Tabs('plugin_tabs');
					
					if(Portal.Data.plugins.updatesExist && Portal.Vars.pluginDetailsClicked == true)
					{
						Portal.Vars.pluginDetailsClicked = false;
						pluginTabs.last();
					}
				}
			}
