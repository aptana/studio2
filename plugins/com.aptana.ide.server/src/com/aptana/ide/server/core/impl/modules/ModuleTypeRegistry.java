...
public final class ModuleTypeRegistry extends RegistryObjectCollection
{
	...
	{
		super("com.aptana.ide.server.moduleTypes"); //$NON-NLS-1$
	}
	...
	{
		return new ModuleType(configurationElement);
	}
	 ...
	 * @return
	 */
	public IModuleType getModuleType(String id)
	{
		return (IModuleType) getObject(id);
	}
}
