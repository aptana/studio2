...
public final class InitializerRegistry extends RegistryObjectCollection
{
	...
	{
		super("com.aptana.ide.server.serverInitializer"); //$NON-NLS-1$
	}
	...
	{
		return new InitializerLazyObject(configurationElement);
	}
	 ...
	 * @return initializer
	 */
	public InitializerLazyObject getInitializer(String typeId){
		return (InitializerLazyObject) getObject(typeId);
	}
