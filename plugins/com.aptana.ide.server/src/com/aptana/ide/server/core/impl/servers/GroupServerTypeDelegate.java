 ...
 */
public class GroupServerTypeDelegate implements IServerTypeDelegate
{

	/**
	 * ID
	 */
	public static final String ID = "com.aptana.ide.server.groupServer"; //$NON-NLS-1$
	...
	{
		return new GroupServer(ServerManager.getFreeId(), ServerCore.getServerManager().getServerType(
				GroupServerTypeDelegate.ID));
	}
