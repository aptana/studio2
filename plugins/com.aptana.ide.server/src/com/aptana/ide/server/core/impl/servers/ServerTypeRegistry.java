 ...
 */
public final class ServerTypeRegistry extends RegistryObjectCollection
{

	/**
	 * 
	 */
	private ServerTypeRegistry()
	{
		super("com.aptana.ide.server.serverTypes"); //$NON-NLS-1$
	}
	...
	{
		return new ServerType(configurationElement);
	}
	
	private static ServerTypeRegistry INSTANCE = null;

	/**
	 * @return instance
	 */
	public static ServerTypeRegistry getServerTypeRegistry()
	{
		if (INSTANCE == null)
		{
			INSTANCE = new ServerTypeRegistry();
		}
		return INSTANCE;
	}
