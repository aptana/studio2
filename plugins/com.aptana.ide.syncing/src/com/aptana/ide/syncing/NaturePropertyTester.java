...
public class NaturePropertyTester extends PropertyTester {
	...
	public boolean test(Object receiver, String property, Object[] args,
		...
		if (NATURE.equals(property)
				&& receiver instanceof IProject && expectedValue instanceof Boolean) {
			...
			try {
				...
				IdeLog.logError(CoreUIPlugin.getDefault(),
						StringUtils.format(Messages.NaturePropertyTester_ERR_WhileTestingProjectNature, project.getName()), e);
			}
		}
		return false;
	}
