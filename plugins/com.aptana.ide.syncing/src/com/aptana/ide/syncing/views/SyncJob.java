			...
			public int compare(VirtualFileSyncPair pair1, VirtualFileSyncPair pair2)
			{
				try
				{
					if (pair1 != null && pair2 != null)
					{
						...
						{
							String s1 = pair1.getSourceFile().getAbsolutePath();
							String s2 = pair2.getSourceFile().getAbsolutePath();
							if (s1 != null)
							{
						...
						{
							String s1 = pair1.getDestinationFile().getAbsolutePath();
							String s2 = pair2.getDestinationFile().getAbsolutePath();
							if (s1 != null)
							{
								return -1 * s1.compareToIgnoreCase(s2);
							}
