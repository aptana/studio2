 ...
 */
public class VirtualProjectSyncDecorator implements ILightweightLabelDecorator
{
	...
	public void decorate(Object element, IDecoration decoration)
	{
		...
		IVirtualFileManager[] tempManagers = ProjectProtocolManager.getInstance().getFileManagers(container.getFullPath().toPortableString());
		for (int i = 0; i < tempManagers.length; i++)
		{
			IVirtualFileManager manager = tempManagers[i];
			if (manager != null && SyncManager.isSyncPairEndpoint(manager))
			{
