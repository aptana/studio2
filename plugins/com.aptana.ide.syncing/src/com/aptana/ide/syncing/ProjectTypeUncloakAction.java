 ...
 * 
 */
public class ProjectTypeUncloakAction extends FileTypeUncloakAction
{
	...
	public void run(IAction action)
	{
		...
		dm.update("com.aptana.ide.syncing.VirtualProjectCloakedDecorator"); //$NON-NLS-1$
	}
	...
	public void selectionChanged(IAction action, ISelection selection)
	{
		...
		setSelectedFiles(ProjectFileManager.convertResourcesToFiles(objects));
