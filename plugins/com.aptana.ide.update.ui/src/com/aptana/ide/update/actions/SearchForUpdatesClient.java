...
/**
 * This comet client searches for updates to currently installed features/plugins
 * 
 * @author Kevin Sawicki (ksawicki@aptana.com)
 */
public class SearchForUpdatesClient extends CometResponderClient
{
	...
	{
		Activator.getDefault().checkForUpdates();
	...
	{
		return new String[] { "/portal/plugins/updates" }; //$NON-NLS-1$
	}
