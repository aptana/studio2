...
dojo.lang.hitch = function(_1ae, _1af){
    ...
    var fcn = (dojo.lang.isString(_1af) ? _1ae[_1af] : _1af) ||
    function(){
    };
    return function(){
        var ta = args.concat([]);
...
dojo.html.getUnitValue = function(node, _483, _484){
    ...
    return {
        value: Number(_486[1]),
        units: _486[2].toLowerCase()
    };
};
dojo.html.getUnitValue.bad = {
    value: NaN,
    units: ""
};
if (dojo.render.html.ie) {
...
dojo.html.getPaddingBox = function(node){
    ...
    return {
        width: box.width - _51c.width,
        height: box.height - _51c.height
    };
};
dojo.html.getContentBox = function(node){
    ...
    return {
        width: node.offsetWidth - _51e.width,
        height: node.offsetHeight - _51e.height
    };
};
dojo.html.setContentBox = function(node, args){
    ...
    var _524 = (isbb ? dojo.html.getPadBorder(node) : {
        width: 0,
        height: 0
    });
    var ret = {};
...
dojo.html.getMarginBox = function(node){
    ...
    return {
        width: _527.width + _528.width,
        height: _527.height + _528.height
    };
};
dojo.html.setMarginBox = function(node, args){
    ...
    var _52c = 0;
    var isbb = dojo.html.isBorderBox(node);
    var _52e = (!isbb ? dojo.html.getPadBorder(node) : {
        width: 0,
        height: 0
    });
...
dojo.lfx.html.propertyAnimation = function(_557, _558, _559, _55a, _55b){
    ...
    var _55c = {
        ...
        "nodes": _557,
        "duration": _559,
        "easing": _55a || dojo.lfx.easeDefault
    };
...
dojo.lfx.html.fadeIn = function(_583, _584, _585, _586){
    return dojo.lfx.html.fade(_583, {
        end: 1
    }, _584, _585, _586);
};
dojo.lfx.html.fadeOut = function(_587, _588, _589, _58a){
    return dojo.lfx.html.fade(_587, {
        end: 0
    }, _588, _589, _58a);
};
