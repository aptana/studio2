 ...
 */
public class IdentifierMatcherTest extends TestCase
{
	private IdentifierMatcher _matcher;
	...
	{
		this._matcher = new IdentifierMatcher();
	}
	...
	public void testStartCharacters()
	{
		...
		char[] source2 = "_abc".toCharArray();
		char[] source3 = "!abc".toCharArray();
		...
		this._matcher.setStartCharacters("-_!");
	 ...
	 * testPartCharacters
	 */
	public void testPartCharacters()
	{
		char[] source1 = "a-abc".toCharArray();
		char[] source2 = "a_abc".toCharArray();
		char[] source3 = "a!abc".toCharArray();
		...
		this._matcher.setPartCharacters("-_!");
