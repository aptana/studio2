 ...
 */
public class EndOfFileMatcherTest extends TestCase
{
	private EndOfFileMatcher _matcher;
	...
	{
		this._matcher = new EndOfFileMatcher();
	}
	...
	public void testEndOfString()
	{
		...
		int result = this._matcher.match(source, 7, source.length);
	 ...
	 * testBeforeEndOfFile
	 */
	public void testBeforeEndOfFile()
	{
		char[] source = "testing".toCharArray();
	...
	/**
	 * testNegatedBeforeEndOfFile
	 */
	public void testNegatedBeforeEndOfFile()
	{
		char[] source = "testing".toCharArray();
