...
public class StringMatcherTest extends TestCase
{
	...
	{
		this._matcher = new StringMatcher();
	}
	...
	public void testCaseInsensitive()
	{
		...
		char[] source2 = "Test".toCharArray();
		char[] source3 = "tEst".toCharArray();
		char[] source4 = "teSt".toCharArray();
		char[] source5 = "tesT".toCharArray();
		char[] source6 = "TEST".toCharArray();
