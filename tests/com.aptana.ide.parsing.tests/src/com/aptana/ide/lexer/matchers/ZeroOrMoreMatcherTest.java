 ...
 */
public class ZeroOrMoreMatcherTest extends TestCase
{
	private ZeroOrMoreMatcher _matcher;
	...
	{
		this._matcher = new ZeroOrMoreMatcher();
	}
	...
	public void testMultipleMatches()
	{
		...
		this._matcher.appendChild(new CharacterClassMatcher("abc"));
