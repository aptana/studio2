...
public class OrMatcherTest extends TestCase
{
	...
	public void testFirstMatch()
	{
		...
		this._matcher.appendChild(new CharacterMatcher('c'));
	 ...
	 * testNonFirstMatch
	 */
	public void testNonFirstMatch()
	{
		char[] source = "bca".toCharArray();
