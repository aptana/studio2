...
public class AndMatcherTest extends TestCase
{
	...
	public void testSingleChild()
	{
		...
		this._matcher.appendChild(new StringMatcher("test"));
	...
	public void testTwoChildren()
	{
		...
		this._matcher.appendChild(new StringMatcher("test"));
		this._matcher.appendChild(new StringMatcher("ing"));
