...
public class TestWhitespaceTokens extends TestTokenBase
{
	...
	{
		this.lexer.setIgnoreSet(HTMLMimeType.MimeType, null);
		this.lexemeTest(" \t\r\n", TokenCategories.WHITESPACE, HTMLTokenTypes.WHITESPACE); //$NON-NLS-1$
	}
	...
	{
		this.lexer.setIgnoreSet(HTMLMimeType.MimeType, null);
		this.lexemeTest("<!-- this is a comment -->", TokenCategories.WHITESPACE, HTMLTokenTypes.COMMENT); //$NON-NLS-1$
	}
	 ...
	 */
	public void testAttributeWhitespace() throws LexerException
	{
		this.lexer.setIgnoreSet(HTMLMimeType.MimeType, null);
		this.lexer.setGroup(HTMLParser.ATTRIBUTE_GROUP);
		this.lexemeTest(" \t\r\n", TokenCategories.ERROR, HTMLTokenTypes.WHITESPACE); //$NON-NLS-1$
	}
}
