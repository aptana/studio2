...
if (typeof dojo == "undefined") {
    ...
    dojo._loadModule = function( /*String*/moduleName,    /*Boolean?*/
    exactOnly,    /*Boolean?*/
    omitModuleCheck){
        //	summary:
                    ...
                    if (!relobj.scheme) {
                        ...
                        if (!relobj.authority) {
                            ...
                            if (relobj.path.charAt(0) != "/") {
                                var path = uriobj.path.substring(0, uriobj.path.lastIndexOf("/") + 1) +
                                relobj.path;
    ...
    if (typeof window != 'undefined') {
        ...
        dojo.withGlobal = function( /*Object*/globalObject,        /*Function*/
        callback,        /*Object?*/
        thisObject,        /*Array?*/
        cbArguments){
            // summary:
        ...
        dojo.withDoc = function( /*Object*/documentObject,        /*Function*/
        callback,        /*Object?*/
        thisObject,        /*Array?*/
        cbArguments){
            // summary:
...
if (!dojo._hasResource["dojo._base.connect"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dojo.connect = function(/*Object|null*/obj,    /*String*/
    event,    /*Object|null*/
    ...
    dojo.connectPublisher = function( /*String*/topic,    /*Object|null*/
    obj,    /*String*/
    event){
        // summary:
...
if (!dojo._hasResource["dojo._base.array"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    (function(){
        var _getParts = function(arr, obj, cb){
            return [(dojo.isString(arr) ? arr.split("") : arr), (obj || dojo.global),            // FIXME: cache the anonymous functions we create here?
            (dojo.isString(cb) ? (new Function("item", "index", "array", cb)) : cb)];
        }
        
        dojo.mixin(dojo, {
            indexOf: function( /*Array*/array,            /*Object*/
            value,            /*Integer?*/
            fromIndex,            /*Boolean?*/
            findLast){
                // summary:
...
if (!dojo._hasResource["dojo._base.Color"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    dojo.blendColors = function(    /*dojo.Color*/
    start,    /*dojo.Color*/
    end,    /*Number*/
    weight,    /*dojo.Color?*/
    obj){
 ...
 : function(node, opacity){
        ...
        var _toStyleValue = function(node, type, value){
            ...
            if (_pixelNamesCache[type] === true) {
                ...
                if (_pixelNamesCache[type] === false) {
                    return value;
                }
                else {
        ...
        dojo._setMarginBox = function(/*DomNode*/node, /*Number?*/ leftPx, /*Number?*/ topPx,        /*Number?*/
        widthPx, /*Number?*/ heightPx,        /*Object*/
        computedStyle){
            //	summary:
        ...
        dojo._isBodyLtr = function(){
            ...
            return typeof dojo._bodyLtr == "undefined" ? (dojo._bodyLtr = dojo.getComputedStyle(dojo.body()).direction == "ltr") : dojo._bodyLtr; // Boolean 
        }
    ...
    (function(){
        ...
        if (d.isIE) {
            ...
            var subClassStr = function(className){
                return (                // "parent.dojo.debug('setting it up...'); " +
...
if (!dojo._hasResource["dojo._base.query"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    (function(){
        ...
        // calling semantics.
        var xPathAttrs = [        // FIXME: need to re-order in order of likelyness to be used in matches
        {
            key: "|=",
        ...
        var getXPathFunc = function(path){
            ...
            var tf = function(parent){
                ...
                var xpathResult;
                try {
                    xpathResult = doc.evaluate(xpath, parent, null,                    // XPathResult.UNORDERED_NODE_ITERATOR_TYPE, null);
        ...
        var attrs = [        // FIXME: need to re-order in order of likelyness to be used in matches
        {
            key: "|=",
            match: function(attr, value){
                // E[hreflang|="en"]
...
if (!dojo._hasResource["dojo._base.xhr"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
    ...
    (function(){
        ...
        dojo._ioSetArgs = function(/*Object*/args,        /*Function*/
        canceller,        /*Function*/
        okHandler,        /*Function*/
        errHandler){
            //	summary: 
        ...
        dojo._ioWatch = function(/*Deferred*/dfd,        /*Function*/
        validCheck,        /*Function*/
        ioCheck,        /*Function*/
        resHandle){
