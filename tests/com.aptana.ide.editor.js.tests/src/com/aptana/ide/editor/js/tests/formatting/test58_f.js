    ...
    jQuery.extend({
        ...
        find: function(t, context){
            ...
            if (!t.indexOf("//")) {
                ...
                if (!t.indexOf("/") && !context.ownerDocument) {
                    context = context.documentElement;
                    ...
                    if (m[1] == ".") 
                        ...
                        // We can get a speed boost by handling nth-child here
                            ...
                            if (m[1] == ":" && m[2] == "nth-child") {
                                var num = jQuery.mergeNum++, tmp = [], test = /(\d*)n\+?(\d*)/.exec(m[3] == "even" && "2n" || m[3] == "odd" && "2n+1" ||
                                !/\D/.test(m[3]) && "n+" + m[3] ||
            ...
            jQuery.ajax({
                ...
                complete: function(res, status){
                    if (status == "success" || !ifModified && status == "notmodified") 
                        ...
                        self.attr("innerHTML", res.responseText)                    // Execute all the scripts inside of the newly-injected HTML
                        .evalScripts()                    // Execute callback
