...
public class TestDelimiterTokens extends TestTokenBase
{
	...
	{
		this.lexemeTest("/*", TokenCategories.DELIMITER, JSCommentTokenTypes.START_MULTILINE_COMMENT); //$NON-NLS-1$
	}

	/**
	 * testStartSingleLineComment
	 */
	public void testStartSingleLineComment()
	{
		this.lexemeTest("//", TokenCategories.DELIMITER, JSCommentTokenTypes.START_SINGLELINE_COMMENT); //$NON-NLS-1$
	}
	 ...
	 */
	public void testEndMultiLineComment() throws LexerException
	{
		this.lexer.setGroup("multiline"); //$NON-NLS-1$
		this.lexemeTest("*/", TokenCategories.DELIMITER, JSCommentTokenTypes.END_MULTILINE_COMMENT); //$NON-NLS-1$
	}
}
