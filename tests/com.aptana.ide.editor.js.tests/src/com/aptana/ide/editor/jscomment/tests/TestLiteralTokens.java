...
public class TestLiteralTokens extends TestTokenBase
{
	 ...
	 */
	public void testMultiLineTextLiteral() throws LexerException
	{
		this.lexer.setGroup("multiline"); //$NON-NLS-1$
		this.lexemeTest("this is some text", TokenCategories.LITERAL, JSCommentTokenTypes.TEXT); //$NON-NLS-1$
	}
	 ...
	 * @throws LexerException
	 */
	public void testSingleLineTextLiteral() throws LexerException
	{
