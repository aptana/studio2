...
public class TestIdentifierTokens extends TestTokenBase
{
	 ...
	 */
	public void testDottedIdentifier() throws LexerException
	{
		this.lexer.setGroup("identifier"); //$NON-NLS-1$
		this.lexemeTest("MyBase.ClassA", TokenCategories.IDENTIFIER, ScriptDocTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
}
