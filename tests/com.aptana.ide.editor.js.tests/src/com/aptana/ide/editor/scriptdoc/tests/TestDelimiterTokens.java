...
public class TestDelimiterTokens extends TestTokenBase
{
	...
	{
		this.lexemeTest("/**", TokenCategories.DELIMITER, ScriptDocTokenTypes.START_DOCUMENTATION); //$NON-NLS-1$
	}
	...
	public void testEndDocumentation() throws LexerException
	{
		...
		this.lexemeTest("*/", TokenCategories.DELIMITER, ScriptDocTokenTypes.END_DOCUMENTATION); //$NON-NLS-1$
	}
	...
	{
		this.lexer.setGroup("indent"); //$NON-NLS-1$
		this.lexemeTest("*", TokenCategories.DELIMITER, ScriptDocTokenTypes.STAR); //$NON-NLS-1$
	}
}
