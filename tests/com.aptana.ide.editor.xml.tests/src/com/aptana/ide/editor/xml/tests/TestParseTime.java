...
import com.aptana.ide.editor.xml.parsing.XMLScanner;
...
public class TestParseTime extends TestCase
{
	...
	{
		XMLParseState parseState = (XMLParseState) this._parser.createParseState(null);
		AbstractLexer lexer;
