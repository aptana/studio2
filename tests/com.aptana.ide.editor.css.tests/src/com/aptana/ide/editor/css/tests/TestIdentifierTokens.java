...
public class TestIdentifierTokens extends TestTokenBase
{
	...
	{
		this.lexemeTest("abc", TokenCategories.IDENTIFIER, CSSTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
	
	/**
	 * testIdentifierWithNumber
	 */
	public void testIdentifierWithNumber()
	{
		this.lexemeTest("abc0", TokenCategories.IDENTIFIER, CSSTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
	
	/**
	 * testIdentifierWithHyphen
	 */
	public void testIdentifierWithHyphen()
	{
		this.lexemeTest("abc-def", TokenCategories.IDENTIFIER, CSSTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
	
	/**
	 * testIdentifierWithLeadingHyphen
	 */
	...
	/**
	 * testIdentifierWithUnderscore
	 */
	public void testIdentifierWithUnderscore()
	{
		this.lexemeTest("abc_def", TokenCategories.IDENTIFIER, CSSTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
	
	/**
	 * testIdentifierWithLeadingUnderscore
	 */
	public void testIdentifierWithLeadingUnderscore()
	{
		this.lexemeTest("_abc", TokenCategories.IDENTIFIER, CSSTokenTypes.IDENTIFIER); //$NON-NLS-1$
	}
}
